    ...
    public class DataHelper
    {
        ...
        public static DateTime ParseDate(object dataRowFieldValue)
        {
            ...
            try
            {
                ...
                if (dataRowFieldValue is DateTime dateValueConverted)
                {
                    // cast as a DateTime
                    dateValue = dateValueConverted;
                }
            }
            catch
            {
        ...
        public static Guid ParseGuid(object dataRowFieldValue)
        {
            ...
            try
            {
                // test for the is a Guid
                if (dataRowFieldValue is Guid dataRowFieldValueGuid)
                {
                    // Parse guidValue
                    guidValue = dataRowFieldValueGuid;
                }
            }
            catch
            {
        ...
        public static double ParseDouble(object dataRowFieldValue, double defaultValue)
        {
            ...
            try
            {
                ...
                if (dataRowFieldValue is Single singleFieldValue)
                {
                    // cast as a Double now.
                    doubleValue = (Double) singleFieldValue;
                }
                else if (dataRowFieldValue is Double doubleFieldValue)
                {
                    // cast a double
                    doubleValue = (Double) doubleFieldValue;
                }
                else if (dataRowFieldValue is Decimal decimalFieldValue)
                {
                    // parse as a Double
                    doubleValue = (Double) decimalFieldValue;
                }
            }
            catch
            {
        ...
        /// <returns></returns>
        public static DataRow ReturnFirstRow(DataSet dataSet)
        {
            // Initial Value
            DataRow row = null;
        ...
        public static DataTable ReturnFirstTable(DataSet dataSet)
        {
            // Initial Value
        ...
        /// <returns>True as long as there is not an error, false if there is.
        /// </returns>
        public static bool UpdateRecord(StoredProcedure storedProcedure, DataConnector databaseConnector)
        {
            // initial value
            bool saved = false;
