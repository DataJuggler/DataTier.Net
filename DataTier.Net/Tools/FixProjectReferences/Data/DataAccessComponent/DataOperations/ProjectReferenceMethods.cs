...
namespace DataAccessComponent.DataOperations
{
    ...
    /// </summary>
    public class ProjectReferenceMethods
    {
        ...
        #region Constructor
        /// <summary>
        /// Creates a new Creates a new 'ProjectReferenceMethods' object.
        /// </summary>
        public ProjectReferenceMethods(DataManager dataManagerArg)
        {
            // Save Argument
        ...
        #region Methods
            ...
            internal PolymorphicObject DeleteProjectReference(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if(deleteProjectReferenceProc != null)
                    {
                        ...
                        bool deleted = this.DataManager.ProjectReferenceManager.DeleteProjectReference(deleteProjectReferenceProc, dataConnector);
            ...
            internal PolymorphicObject FetchAll(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                ...
                if(fetchAllProc!= null)
                {
                    ...
                    projectReferenceListCollection = this.DataManager.ProjectReferenceManager.FetchAllProjectReferences(fetchAllProc, dataConnector);
            ...
            /// <param name='List<PolymorphicObject>'>The 'ProjectReference' to delete.
            /// <returns>A PolymorphicObject object with a Boolean value.
            internal PolymorphicObject FindProjectReference(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                PolymorphicObject returnObject = new PolymorphicObject();
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if (parameters[0].ObjectValue as ProjectReference != null)
                    {
                        ...
                        if(findProjectReferenceProc != null)
                        {
                            ...
                            projectReference = this.DataManager.ProjectReferenceManager.FindProjectReference(findProjectReferenceProc, dataConnector);
            ...
            /// <returns>A PolymorphicObject object with a Boolean value.
            internal PolymorphicObject InsertProjectReference(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                PolymorphicObject returnObject = new PolymorphicObject();
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if (parameters[0].ObjectValue as ProjectReference != null)
                    {
                        ...
                        if(insertProjectReferenceProc != null)
                        {
                            ...
                            returnObject.IntegerValue = this.DataManager.ProjectReferenceManager.InsertProjectReference(insertProjectReferenceProc, dataConnector);
                        }
            ...
            internal PolymorphicObject UpdateProjectReference(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                PolymorphicObject returnObject = new PolymorphicObject();
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if (parameters[0].ObjectValue as ProjectReference != null)
                    {
                        ...
                        if(updateProjectReferenceProc != null)
                        {
                            ...
                            bool saved = this.DataManager.ProjectReferenceManager.UpdateProjectReference(updateProjectReferenceProc, dataConnector);
