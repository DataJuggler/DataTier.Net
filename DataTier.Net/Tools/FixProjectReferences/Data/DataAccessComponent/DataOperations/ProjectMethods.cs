...
namespace DataAccessComponent.DataOperations
{
    ...
    public class ProjectMethods
    {
        ...
        #region Constructor
        /// <summary>
        /// Creates a new Creates a new 'ProjectMethods' object.
        /// </summary>
        public ProjectMethods(DataManager dataManagerArg)
        {
            // Save Argument
        ...
        #region Methods
            ...
            internal PolymorphicObject DeleteProject(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if(deleteProjectProc != null)
                    {
                        ...
                        bool deleted = this.DataManager.ProjectManager.DeleteProject(deleteProjectProc, dataConnector);
            ...
            internal PolymorphicObject FetchAll(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                ...
                if(fetchAllProc!= null)
                {
                    ...
                    projectListCollection = this.DataManager.ProjectManager.FetchAllProjects(fetchAllProc, dataConnector);
            ...
            /// <param name='List<PolymorphicObject>'>The 'Project' to delete.
            /// <returns>A PolymorphicObject object with a Boolean value.
            internal PolymorphicObject FindProject(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                PolymorphicObject returnObject = new PolymorphicObject();
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if (parameters[0].ObjectValue as Project != null)
                    {
                        ...
                        if(findProjectProc != null)
                        {
                            ...
                            project = this.DataManager.ProjectManager.FindProject(findProjectProc, dataConnector);
            ...
            /// <returns>A PolymorphicObject object with a Boolean value.
            internal PolymorphicObject InsertProject(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                PolymorphicObject returnObject = new PolymorphicObject();
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if (parameters[0].ObjectValue as Project != null)
                    {
                        ...
                        if(insertProjectProc != null)
                        {
                            ...
                            returnObject.IntegerValue = this.DataManager.ProjectManager.InsertProject(insertProjectProc, dataConnector);
                        }
