...
namespace DataAccessComponent.Data
{
    ...
    public class FieldSetManager
    {
        ...
        #region Methods
            ...
            /// </summary>
            public bool DeleteFieldSet(DeleteFieldSetStoredProcedure deleteFieldSetProc, DataConnector databaseConnector)
            {
                // Initial Value
                bool deleted = false;
                ...
                {
                    // Execute Non Query
                    deleted = this.DataHelper.DeleteRecord(deleteFieldSetProc, databaseConnector);
                }
            ...
            /// </summary>
            public int InsertFieldSet(InsertFieldSetStoredProcedure insertFieldSetProc, DataConnector databaseConnector)
            {
                // Initial Value
                int newIdentity = -1;
                ...
                {
                    // Execute Non Query
                    newIdentity = this.DataHelper.InsertRecord(insertFieldSetProc, databaseConnector);
                }
            ...
            /// <returns>True if successful false if not.</returns>
            /// </summary>
            public bool UpdateFieldSet(UpdateFieldSetStoredProcedure updateFieldSetProc, DataConnector databaseConnector)
            {
                // Initial Value
                bool saved = false;
                ...
                {
                    // Execute Update.
                    saved = this.DataHelper.UpdateRecord(updateFieldSetProc, databaseConnector);
                }
