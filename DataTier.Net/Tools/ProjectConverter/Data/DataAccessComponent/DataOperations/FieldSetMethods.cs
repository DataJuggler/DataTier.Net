            ...
            internal static PolymorphicObject DeleteFieldSet(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if(deleteFieldSetProc != null)
                    {
                        ...
                        bool deleted = FieldSetManager.DeleteFieldSet(deleteFieldSetProc, dataConnector);
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if (parameters[0].ObjectValue as FieldSet != null)
                    {
                        ...
                        if(insertFieldSetProc != null)
                        {
                            ...
                            returnObject.IntegerValue = FieldSetManager.InsertFieldSet(insertFieldSetProc, dataConnector);
                        }
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if (parameters[0].ObjectValue as FieldSet != null)
                    {
                        ...
                        if(updateFieldSetProc != null)
                        {
                            ...
                            bool saved = FieldSetManager.UpdateFieldSet(updateFieldSetProc, dataConnector);
