...
namespace DataAccessComponent.Controllers
{
    ...
    public class ProjectReferencesViewController
    {
        ...
        #region Methods
            ...
            #region FetchAll(ProjectReferencesView tempProjectReferencesView, DataManager dataManager)
            /// <summary>
            ...
            public static List<ProjectReferencesView> FetchAll(ProjectReferencesView tempProjectReferencesView, DataManager dataManager)
            {
                // Initial value
                ...
                try
                {
                    ...
                    ApplicationController.DataOperationMethod fetchAllMethod = ProjectReferencesViewMethods.FetchAll;
