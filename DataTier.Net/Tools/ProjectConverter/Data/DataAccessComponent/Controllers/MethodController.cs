...
namespace DataAccessComponent.Controllers
{
    ...
    public class MethodController
    {
        ...
        #region Methods
            ...
            private static List<PolymorphicObject> CreateMethodParameter(Method method)
            {
                // Initial Value
            ...
            #region Delete(Method tempMethod, DataManager dataManager)
            /// <summary>
            ...
            public static bool Delete(Method tempMethod, DataManager dataManager)
            {
                ...
                try
                {
                    ...
                    if (tempMethod != null)
                    {
                        ...
                        ApplicationController.DataOperationMethod deleteMethodMethod = MethodMethods.DeleteMethod;
            ...
            #region FetchAll(Method tempMethod, DataManager dataManager)
            /// <summary>
            ...
            public static List<Method> FetchAll(Method tempMethod, DataManager dataManager)
            {
                // Initial value
                ...
                try
                {
                    ...
                    ApplicationController.DataOperationMethod fetchAllMethod = MethodMethods.FetchAll;
            ...
            #region Find(Method tempMethod, DataManager dataManager)
            /// <summary>
            ...
            public static Method Find(Method tempMethod, DataManager dataManager)
            {
                // Initial values
                Method method = null;
                ...
                try
                {
                    ...
                    if (tempMethod != null)
                    {
                        ...
                        ApplicationController.DataOperationMethod findMethod = MethodMethods.FindMethod;
            ...
            #region Insert(Method method, DataManager dataManager)
            /// <summary>
            ...
            #region Save(ref Method method, DataManager dataManager)
            /// <summary>
            ...
            #region Update(Method method, DataManager dataManager)
            /// <summary>
            ...
            public static bool Update(Method method, DataManager dataManager)
            {
                ...
                try
                {
                    ...
                    {
                        // Create Delegate
                        ApplicationController.DataOperationMethod updateMethod = MethodMethods.UpdateMethod;
