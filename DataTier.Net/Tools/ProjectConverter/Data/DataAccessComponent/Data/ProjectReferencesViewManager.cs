...
namespace DataAccessComponent.Data
{
    ...
    public class ProjectReferencesViewManager
    {
        ...
        #region Methods
            ...
            /// </summary>
            public static List<ProjectReferencesView> FetchAllProjectReferencesViews(FetchAllProjectReferencesViewsStoredProcedure fetchAllProjectReferencesViewsProc, DataConnector databaseConnector)
            {
                // Initial Value
                ...
                {
                    // First Get Dataset
                    DataSet allProjectReferencesViewsDataSet = DataHelper.LoadDataSet(fetchAllProjectReferencesViewsProc, databaseConnector);

                    // Verify DataSet Exists
                    if(allProjectReferencesViewsDataSet != null)
                    {
                        // Get DataTable From DataSet
                        DataTable table = DataHelper.ReturnFirstTable(allProjectReferencesViewsDataSet);
