...
namespace DataAccessComponent.Data
{
    ...
    public class FieldSetFieldManager
    {
        ...
        #region Methods
            ...
            /// </summary>
            public static bool DeleteFieldSetField(DeleteFieldSetFieldStoredProcedure deleteFieldSetFieldProc, DataConnector databaseConnector)
            {
                // Initial Value
                bool deleted = false;
                ...
                {
                    // Execute Non Query
                    deleted = DataHelper.DeleteRecord(deleteFieldSetFieldProc, databaseConnector);
                }
            ...
            /// </summary>
            public static List<FieldSetField> FetchAllFieldSetFields(FetchAllFieldSetFieldsStoredProcedure fetchAllFieldSetFieldsProc, DataConnector databaseConnector)
            {
                // Initial Value
                ...
                {
                    // First Get Dataset
                    DataSet allFieldSetFieldsDataSet = DataHelper.LoadDataSet(fetchAllFieldSetFieldsProc, databaseConnector);

                    // Verify DataSet Exists
                    if(allFieldSetFieldsDataSet != null)
                    {
                        // Get DataTable From DataSet
                        DataTable table = DataHelper.ReturnFirstTable(allFieldSetFieldsDataSet);
            ...
            /// </summary>
            public static FieldSetField FindFieldSetField(FindFieldSetFieldStoredProcedure findFieldSetFieldProc, DataConnector databaseConnector)
            {
                // Initial Value
                ...
                {
                    // First Get Dataset
                    DataSet fieldSetFieldDataSet = DataHelper.LoadDataSet(findFieldSetFieldProc, databaseConnector);

                    // Verify DataSet Exists
                    if(fieldSetFieldDataSet != null)
                    {
                        // Get DataTable From DataSet
                        DataRow row = DataHelper.ReturnFirstRow(fieldSetFieldDataSet);
            ...
            /// </summary>
            public static int InsertFieldSetField(InsertFieldSetFieldStoredProcedure insertFieldSetFieldProc, DataConnector databaseConnector)
            {
                // Initial Value
                int newIdentity = -1;
                ...
                {
                    // Execute Non Query
                    newIdentity = DataHelper.InsertRecord(insertFieldSetFieldProc, databaseConnector);
                }
            ...
            /// <returns>True if successful false if not.</returns>
            /// </summary>
            public static bool UpdateFieldSetField(UpdateFieldSetFieldStoredProcedure updateFieldSetFieldProc, DataConnector databaseConnector)
            {
                // Initial Value
                bool saved = false;
                ...
                {
                    // Execute Update.
                    saved = DataHelper.UpdateRecord(updateFieldSetFieldProc, databaseConnector);
                }
