...
namespace DataTierClient.Builders
{
    ...
    public class GatewayCreator : CSharpClassWriter
    {
        ...
        /// </summary>
        public GatewayCreator(List<DataTable> dataTablesArg, ReferencesSet objectReferencesArg, string gatewayPathArg, string projectNameArg, string nameSpaceNameArg, ProjectFileManager fileManager) : base(fileManager, false)
		{   
		    // Set Properties
