...
namespace DataTierClient.Builders
{
	...
	public class DataOperationsManagerCreator : CSharpClassWriter
	{
        ...
        /// </summary>
        public DataOperationsManagerCreator(List<DataTable> dataTablesArg, ReferencesSet objectReferencesArg, string rootDataOperationsPathArg, string projectNameArg, string nameSpaceNameArg, ProjectFileManager fileManager) : base(fileManager, false)
		{   
		    // Set Properties
