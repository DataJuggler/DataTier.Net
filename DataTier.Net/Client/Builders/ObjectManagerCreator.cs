...
namespace DataTierClient.Builders
{
	...
	public class ObjectManagerCreator : CSharpClassWriter
	{
        ...
        /// </summary>
        public ObjectManagerCreator(List<DataTable> dataTablesArg, ReferencesSet objectReferencesArg, string rootDataManagerPathArg, string nameSpaceNameArg, ProjectFileManager fileManager) : base(fileManager, false)
		{   
		    // Set Properties
