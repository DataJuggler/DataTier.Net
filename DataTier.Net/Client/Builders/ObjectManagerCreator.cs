...
namespace DataTierClient.Builders
{
	...
	public class ObjectManagerCreator : CSharpClassWriter
	{
        ...
        /// </summary>
        public ObjectManagerCreator(List<DataTable> dataTablesArg, ReferencesSet objectReferencesArg, string rootDataManagerPathArg, string nameSpaceNameArg, ProjectFileManager fileManager, bool dotNet5Project) : base(fileManager, false, dotNet5Project)
		{   
		    // Set Properties
