...
namespace $safeprojectname$.DataOperations
{
    ...
    public class SystemMethods
    {
        ...
        #region Methods
            ...
            /// </summary>
            private string FindProcedureName(List<PolymorphicObject> parameters)
            {
                // initial value
            ...
            /// </summary>
            private SqlParameter[] FindSqlParameters(List<PolymorphicObject> parameters)
            {
                // initial value
