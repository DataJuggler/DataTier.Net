...
namespace DataAccessComponent.Data
{
    ...
    public class ProjectReferenceManager
    {
        ...
        #region Methods
            ...
            /// </summary>
            public static bool DeleteProjectReference(DeleteProjectReferenceStoredProcedure deleteProjectReferenceProc, DataConnector databaseConnector)
            {
                // Initial Value
                bool deleted = false;
                ...
                {
                    // Execute Non Query
                    deleted = DataHelper.DeleteRecord(deleteProjectReferenceProc, databaseConnector);
                }
            ...
            public static List<ProjectReference> FetchAllProjectReferences(FetchAllProjectReferencesStoredProcedure fetchAllProjectReferencesProc, DataConnector databaseConnector)
            {
                ...
                {
                    // First Get Dataset
                    DataSet allProjectReferencesDataSet = DataHelper.LoadDataSet(fetchAllProjectReferencesProc, databaseConnector);

                    // Verify DataSet Exists
                    if(allProjectReferencesDataSet != null)
                    {
                        // Get DataTable From DataSet
                        DataTable table = DataHelper.ReturnFirstTable(allProjectReferencesDataSet);
            ...
            /// </summary>
            public static ProjectReference FindProjectReference(FindProjectReferenceStoredProcedure findProjectReferenceProc, DataConnector databaseConnector)
            {
                // Initial Value
                ...
                {
                    // First Get Dataset
                    DataSet projectReferenceDataSet = DataHelper.LoadDataSet(findProjectReferenceProc, databaseConnector);

                    // Verify DataSet Exists
                    if(projectReferenceDataSet != null)
                    {
                        // Get DataTable From DataSet
                        DataRow row = DataHelper.ReturnFirstRow(projectReferenceDataSet);
            ...
            /// </summary>
            public static int InsertProjectReference(InsertProjectReferenceStoredProcedure insertProjectReferenceProc, DataConnector databaseConnector)
            {
                // Initial Value
                int newIdentity = -1;
                ...
                {
                    // Execute Non Query
                    newIdentity = DataHelper.InsertRecord(insertProjectReferenceProc, databaseConnector);
                }
            ...
            /// <returns>True if successful false if not.</returns>
            /// </summary>
            public static bool UpdateProjectReference(UpdateProjectReferenceStoredProcedure updateProjectReferenceProc, DataConnector databaseConnector)
            {
                // Initial Value
                bool saved = false;
                ...
                {
                    // Execute Update.
                    saved = DataHelper.UpdateRecord(updateProjectReferenceProc, databaseConnector);
                }
