    ...
    public class ProjectWriterBase
    {
        ...
        #region Static Methods
            ...
            internal static SqlParameter[] CreateInsertParameters(Project project)
            {
                ...
                if(project != null)
                {
                    // Create [AddIGridValueInterface] parameter
                    param = new SqlParameter("@AddIGridValueInterface", project.AddIGridValueInterface);
            ...
            internal static SqlParameter[] CreateUpdateParameters(Project project)
            {
                ...
                if(project != null)
                {
                    // Create parameter for [AddIGridValueInterface]
                    param = new SqlParameter("@AddIGridValueInterface", project.AddIGridValueInterface);
