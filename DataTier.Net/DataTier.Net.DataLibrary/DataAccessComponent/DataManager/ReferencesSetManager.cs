...
namespace DataAccessComponent.DataManager
{
    ...
    public class ReferencesSetManager
    {
        ...
        #region Methods
            ...
            /// </summary>
            public bool DeleteReferencesSet(DeleteReferencesSetStoredProcedure deleteReferencesSetProc, DataConnector databaseConnector)
            {
                // Initial Value
                bool deleted = false;
                ...
                {
                    // Execute Non Query
                    deleted = this.DataHelper.DeleteRecord(deleteReferencesSetProc, databaseConnector);
                }
            ...
            /// </summary>
            public List<ReferencesSet> FetchAllReferencesSets(FetchAllReferencesSetsStoredProcedure fetchAllReferencesSetsProc, DataConnector databaseConnector)
            {
                // Initial Value
                ...
                {
                    // First Get Dataset
                    DataSet allReferencesSetsDataSet = this.DataHelper.LoadDataSet(fetchAllReferencesSetsProc, databaseConnector);

                    // Verify DataSet Exists
                    if(allReferencesSetsDataSet != null)
                    {
                        // Get DataTable From DataSet
                        DataTable table = this.DataHelper.ReturnFirstTable(allReferencesSetsDataSet);
            ...
            /// </summary>
            public int InsertReferencesSet(InsertReferencesSetStoredProcedure insertReferencesSetProc, DataConnector databaseConnector)
            {
                // Initial Value
                int newIdentity = -1;
                ...
                {
                    // Execute Non Query
                    newIdentity = this.DataHelper.InsertRecord(insertReferencesSetProc, databaseConnector);
                }
            ...
            /// <returns>True if successful false if not.</returns>
            /// </summary>
            public bool UpdateReferencesSet(UpdateReferencesSetStoredProcedure updateReferencesSetProc, DataConnector databaseConnector)
            {
                // Initial Value
                bool saved = false;
                ...
                {
                    // Execute Update.
                    saved = this.DataHelper.UpdateRecord(updateReferencesSetProc, databaseConnector);
                }
