...
namespace DataAccessComponent.DataManager
{
    ...
    public class DTNTableManager
    {
        ...
        #region Methods
            ...
            /// </summary>
            public bool DeleteDTNTable(DeleteDTNTableStoredProcedure deleteDTNTableProc, DataConnector databaseConnector)
            {
                // Initial Value
                bool deleted = false;
                ...
                {
                    // Execute Non Query
                    deleted = this.DataHelper.DeleteRecord(deleteDTNTableProc, databaseConnector);
                }
            ...
            /// </summary>
            public int InsertDTNTable(InsertDTNTableStoredProcedure insertDTNTableProc, DataConnector databaseConnector)
            {
                // Initial Value
                int newIdentity = -1;
                ...
                {
                    // Execute Non Query
                    newIdentity = this.DataHelper.InsertRecord(insertDTNTableProc, databaseConnector);
                }
            ...
            /// <returns>True if successful false if not.</returns>
            /// </summary>
            public bool UpdateDTNTable(UpdateDTNTableStoredProcedure updateDTNTableProc, DataConnector databaseConnector)
            {
                // Initial Value
                bool saved = false;
                ...
                {
                    // Execute Update.
                    saved = this.DataHelper.UpdateRecord(updateDTNTableProc, databaseConnector);
                }
