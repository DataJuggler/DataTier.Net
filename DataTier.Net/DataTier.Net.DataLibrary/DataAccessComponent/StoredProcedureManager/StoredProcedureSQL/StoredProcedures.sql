...
Go
-- =========================================================
-- Procure Name: DTNTable_FetchAllByProjectId
-- Author:           Data Juggler - Data Tier.Net Procedure Generator
-- Create Date:   12/21/2019
...
-- Check if the procedure already exists
IF EXISTS (select * from syscomments where id = object_id ('DTNTable_FetchAllByProjectId'))

    -- Procedure Does Exist, Drop First
    BEGIN

        -- Execute Drop
        Drop Procedure DTNTable_FetchAllByProjectId

        -- Test if procedure was dropped
        IF OBJECT_ID('dbo.DTNTable_FetchAllByProjectId') IS NOT NULL

            -- Print Line Drop Failed
            PRINT '<<< Drop Failed On Procedure DTNTable_FetchAllByProjectId >>>'

        Else

            -- Print Line Procedure Dropped
            PRINT '<<< Drop Suceeded On Procedure DTNTable_FetchAllByProjectId >>>'

    End

GO

Create PROCEDURE DTNTable_FetchAllByProjectId
...
Go
-- =========================================================
-- Procure Name: FieldSetField_FetchAllForFieldSetId
-- Author:           Data Juggler - Data Tier.Net Procedure Generator
-- Create Date:   12/21/2019
-- Description:    Returns all FieldSetField objects for the FieldSetId given.
-- =========================================================

-- Check if the procedure already exists
IF EXISTS (select * from syscomments where id = object_id ('FieldSetField_FetchAllForFieldSetId'))

    -- Procedure Does Exist, Drop First
    BEGIN

        -- Execute Drop
        Drop Procedure FieldSetField_FetchAllForFieldSetId

        -- Test if procedure was dropped
        IF OBJECT_ID('dbo.FieldSetField_FetchAllForFieldSetId') IS NOT NULL

            -- Print Line Drop Failed
            PRINT '<<< Drop Failed On Procedure FieldSetField_FetchAllForFieldSetId >>>'

        Else

            -- Print Line Procedure Dropped
            PRINT '<<< Drop Suceeded On Procedure FieldSetField_FetchAllForFieldSetId >>>'

    End

GO

Create PROCEDURE FieldSetField_FetchAllForFieldSetId
...
Go
-- =========================================================
-- Procure Name: FieldSetFieldView_FetchAllByFieldSetId
-- Author:           Data Juggler - Data Tier.Net Procedure Generator
-- Create Date:   12/21/2019
...
-- Check if the procedure already exists
IF EXISTS (select * from syscomments where id = object_id ('FieldSetFieldView_FetchAllByFieldSetId'))

    -- Procedure Does Exist, Drop First
    BEGIN

        -- Execute Drop
        Drop Procedure FieldSetFieldView_FetchAllByFieldSetId

        -- Test if procedure was dropped
        IF OBJECT_ID('dbo.FieldSetFieldView_FetchAllByFieldSetId') IS NOT NULL

            -- Print Line Drop Failed
            PRINT '<<< Drop Failed On Procedure FieldSetFieldView_FetchAllByFieldSetId >>>'

        Else

            -- Print Line Procedure Dropped
            PRINT '<<< Drop Suceeded On Procedure FieldSetFieldView_FetchAllByFieldSetId >>>'

    End

GO

Create PROCEDURE FieldSetFieldView_FetchAllByFieldSetId
...
Go
-- =========================================================
-- Procure Name: Method_FetchAllByProjectId
-- Author:           Data Juggler - Data Tier.Net Procedure Generator
-- Create Date:   12/21/2019
...
-- Check if the procedure already exists
IF EXISTS (select * from syscomments where id = object_id ('Method_FetchAllByProjectId'))

    -- Procedure Does Exist, Drop First
    BEGIN

        -- Execute Drop
        Drop Procedure Method_FetchAllByProjectId

        -- Test if procedure was dropped
        IF OBJECT_ID('dbo.Method_FetchAllByProjectId') IS NOT NULL

            -- Print Line Drop Failed
            PRINT '<<< Drop Failed On Procedure Method_FetchAllByProjectId >>>'

        Else

            -- Print Line Procedure Dropped
            PRINT '<<< Drop Suceeded On Procedure Method_FetchAllByProjectId >>>'

    End

GO

Create PROCEDURE Method_FetchAllByProjectId
...
Go
-- =========================================================
-- Procure Name: Method_FetchAllForTable
-- Author:           Data Juggler - Data Tier.Net Procedure Generator
-- Create Date:   12/21/2019
...
-- Check if the procedure already exists
IF EXISTS (select * from syscomments where id = object_id ('Method_FetchAllForTable'))

    -- Procedure Does Exist, Drop First
    BEGIN

        -- Execute Drop
        Drop Procedure Method_FetchAllForTable

        -- Test if procedure was dropped
        IF OBJECT_ID('dbo.Method_FetchAllForTable') IS NOT NULL

            -- Print Line Drop Failed
            PRINT '<<< Drop Failed On Procedure Method_FetchAllForTable >>>'

        Else

            -- Print Line Procedure Dropped
            PRINT '<<< Drop Suceeded On Procedure Method_FetchAllForTable >>>'

    End

GO

Create PROCEDURE Method_FetchAllForTable
