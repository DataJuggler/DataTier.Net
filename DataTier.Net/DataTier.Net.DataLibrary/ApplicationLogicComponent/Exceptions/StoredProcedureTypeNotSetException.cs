...
namespace ApplicationLogicComponent.Exceptions
{
    ...
    #region class StoredProcedureTypeNotSetException : CustomException
    /// <summary>
    /// This exception is caused by a calling the
    /// ExecuteStoredProcedure Method in the 
    /// StoredProcedureExecutionManager object 
    /// and the 'StoredProcedureType' property has not been set.
    /// </summary>
    public class StoredProcedureTypeNotSetException : CustomException
    {
        ...
        #region Constructor
        /// <summary>
        /// Creates a new StoredProcedureTypeNotSetException instance.
        /// </summary>
        public StoredProcedureTypeNotSetException(string methodNameArg, string objectNameArg, Exception exceptionArg)
        {
            // Set Properties
        ...
        private void Init()
        {
            ...
            this.DisplayText = "A call to 'ExecuteStoredProcedure was made and the procedure passed in does not have the 'StoredProcedureType' property set.";
