...
namespace ApplicationLogicComponent.Exceptions
{
    ...
    /// 'ExecuteFindProcedure' method in the 
    /// StoredProcedureExecutionManager object 
    /// and the 'TableName' property has not been set.
    /// </summary>
    public class ProcedureTableNameNotSetException : CustomException
    {
        ...
        #region Constructor
        /// <summary>
        /// Creates a new ProcedureTableNameNotSetException instance.
        /// </summary>
        public ProcedureTableNameNotSetException(string methodNameArg, string objectNameArg, Exception exceptionArg)
        {
            // Set Properties
        ...
        private void Init()
        {
            ...
            this.DisplayText = "A call to 'ExecuteFindProcedure was called and the procedure passed in does not have the 'TableName' property set.";
