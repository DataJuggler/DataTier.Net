...
namespace ApplicationLogicComponent.DataOperations
{
    ...
    public class DTNTableMethods
    {
        ...
        #region Constructor
        /// <summary>
        /// Creates a new Creates a new 'DTNTableMethods' object.
        /// </summary>
        public DTNTableMethods(DataManager dataManagerArg)
        {
            // Save Argument
        ...
        #region Methods
            ...
            /// <returns>A PolymorphicObject object with a Boolean value.
            internal PolymorphicObject InsertDTNTable(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                PolymorphicObject returnObject = new PolymorphicObject();
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if (parameters[0].ObjectValue as DTNTable != null)
                    {
                        ...
                        if(insertDTNTableProc != null)
                        {
                            ...
                            returnObject.IntegerValue = this.DataManager.DTNTableManager.InsertDTNTable(insertDTNTableProc, dataConnector);
                        }
            ...
            internal PolymorphicObject UpdateDTNTable(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                PolymorphicObject returnObject = new PolymorphicObject();
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if (parameters[0].ObjectValue as DTNTable != null)
                    {
                        ...
                        if(updateDTNTableProc != null)
                        {
                            ...
                            bool saved = this.DataManager.DTNTableManager.UpdateDTNTable(updateDTNTableProc, dataConnector);
