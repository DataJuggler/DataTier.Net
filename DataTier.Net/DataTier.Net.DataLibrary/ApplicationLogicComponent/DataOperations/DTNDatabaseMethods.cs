...
namespace ApplicationLogicComponent.DataOperations
{
    ...
    /// </summary>
    public class DTNDatabaseMethods
    {
        ...
        #region Constructor
        /// <summary>
        /// Creates a new Creates a new 'DTNDatabaseMethods' object.
        /// </summary>
        public DTNDatabaseMethods(DataManager dataManagerArg)
        {
            // Save Argument
        ...
        #region Methods
            ...
            /// <returns>A PolymorphicObject object with a Boolean value.
            internal PolymorphicObject InsertDTNDatabase(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                PolymorphicObject returnObject = new PolymorphicObject();
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if (parameters[0].ObjectValue as DTNDatabase != null)
                    {
                        ...
                        if(insertDTNDatabaseProc != null)
                        {
                            ...
                            returnObject.IntegerValue = this.DataManager.DTNDatabaseManager.InsertDTNDatabase(insertDTNDatabaseProc, dataConnector);
                        }
            ...
            internal PolymorphicObject UpdateDTNDatabase(List<PolymorphicObject> parameters, DataConnector dataConnector)
            {
                // Initial Value
                PolymorphicObject returnObject = new PolymorphicObject();
                ...
                if ((dataConnector != null) && (dataConnector.Connected == true))
                {
                    ...
                    if (parameters[0].ObjectValue as DTNDatabase != null)
                    {
                        ...
                        if(updateDTNDatabaseProc != null)
                        {
                            ...
                            bool saved = this.DataManager.DTNDatabaseManager.UpdateDTNDatabase(updateDTNDatabaseProc, dataConnector);
